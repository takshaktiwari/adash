            ...
            <form action="{{ route('admin.settings.store') }}" method="POST" class="card" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="setting_key" value="{{ $setting->setting_key }}" required
                                    placeholder="Setting name / title">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex">
                            <input type="text" class="form-control" name="setting_value" value="{{ $setting->setting_value }}" id="setting_value" required
                                placeholder="Setting name / title">
