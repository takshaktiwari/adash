        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box d-flex">
                <a href="{{ url('/') }}" target="_blank" class="logo logo-light text-white m-auto">
                    <span class="logo-sm">
                        <h2 class="mb-0">{{ config('adash.name.small') }}</h2>
                    </span>
                    <span class="logo-lg mb-0">
                        <h2 class="mb-0 d-flex">
                            <span>{{ config('adash.name.long') }}</span> 
                        </h2>
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{ auth()->user()->profile_img() }}" alt="Header Avatar">
                </button>
