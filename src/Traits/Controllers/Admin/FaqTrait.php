...
trait FaqTrait {
	...
	public function store(Request $request, FaqAction $faq)
	{
	    ...
	    return redirect()->route('admin.faqs.index')->withSuccess('SUCCESS !! New FAQ has been added');
	}
	...
	public function update(Request $request, Faq $faq, FaqAction $action)
	{
	    ...
	    return redirect()->route('admin.faqs.index')->withSuccess('SUCCESS !! FAQ has been updatd');
	}
	...
	public function destroy(Faq $faq)
	{
	    ...
	    $faq->delete();
	    return redirect()->route('admin.faqs.index')->withSuccess('SUCCESS !! Faq has been successfully deleted');
	}
